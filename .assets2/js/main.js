...
/* harmony import */ var _components_scrool__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/scrool */ "./src/js/components/scrool.js");
/* harmony import */ var _components_scrool__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_components_scrool__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _components_hightThanks__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/hightThanks */ "./src/js/components/hightThanks.js");
/* harmony import */ var _components_hightThanks__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_components_hightThanks__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _components_animateAdvantages__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components/animateAdvantages */ "./src/js/components/animateAdvantages.js");
/* harmony import */ var _components_animateAdvantages__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_components_animateAdvantages__WEBPACK_IMPORTED_MODULE_6__);
/* harmony import */ var _components_domen__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./components/domen */ "./src/js/components/domen.js");
/* harmony import */ var _components_domen__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(_components_domen__WEBPACK_IMPORTED_MODULE_7__);
...
/***/ "./src/js/components/animateAdvantages.js":
/*!************************************************!*\
  !*** ./src/js/components/animateAdvantages.js ***!
  \************************************************/
/***/ (() => {
...
/***/ "./src/js/components/hightThanks.js":
/*!******************************************!*\
  !*** ./src/js/components/hightThanks.js ***!
  \******************************************/
/***/ (() => {

if (window.innerWidth > 992 && window.innerWidth < 1120) {
  const thanksRight = document.querySelector(".slider-2");
  console.log(thanksRight.height);
  document.querySelector(".thanks__block-left").style.height = thanksRight.offsetHeight - 40 + "px";
}
...
window.addEventListener("DOMContentLoaded", () => {
  ...
  resizableSwiper("(max-width: 576px)", ".slider-2", {
    loop: true,
    spaceBetween: 10,
    slidesPerView: 3,
    freeMode: true,
...
swiper__WEBPACK_IMPORTED_MODULE_0__["default"].use([swiper__WEBPACK_IMPORTED_MODULE_0__.Navigation, swiper__WEBPACK_IMPORTED_MODULE_0__.Pagination, swiper__WEBPACK_IMPORTED_MODULE_0__.Mousewheel, swiper__WEBPACK_IMPORTED_MODULE_0__.Keyboard, swiper__WEBPACK_IMPORTED_MODULE_0__.Autoplay]);
const swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".thanks__content", {
  cssMode: true,
  loop: true,
  navigation: {
    nextEl: ".btn-next",
...
const swiper2 = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".banks__content", {
  slidesPerView: 4,
  spaceBetween: 10,
  loop: true,
  autoplay: {
...
const swiper3 = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".banks__content-belarus", {
  slidesPerView: 4,
  spaceBetween: 40,
  loop: true,
  autoplay: {
...
const swiper4 = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".banks__content-kazahstan", {
  slidesPerView: 4,
  spaceBetween: 20,
  loop: true,
  autoplay: {
...
const createIframe = function (video) {
...
const clearIframes = () => {
  const frames = document.querySelectorAll(".iframe_conteyner");
  frames.forEach(el => {
    el.innerHTML = "";
  });
};
document.querySelectorAll(".thanks__content .swiper-slide").forEach((el, idx) => {
  el.setAttribute("data-index", idx);
});
swiper.on("slideChange", function (e) {
  let index = swiper.activeIndex;
  index = index;
  const framesLength = document.querySelectorAll(".thanks__content .swiper-slide:not(.swiper-slide-duplicate)").length;
  if (index < 0) {
    index = framesLength - 1;
  }
  const currentSlide = document.querySelector(`.swiper-slide[data-index="${index}"]`);
  const frameContainer = currentSlide.querySelector(".iframe_conteyner");
  const video = frameContainer.dataset.video;
  clearIframes();
...
const rules = [{
  ...
  rules: [{
    rule: "required",
    value: true,
    errorMessage: "Заполните сайт вашей компании или название вашей компании!"
  }]
}, {
...
const validateForms = (selector, rules, afterSend) => {
  ...
  validation.onSuccess(ev => {
    ...
    xhr.open("POST", "https://ak-i.ru/ac/php/send3.php", true);
    xhr.send(formData);
    ev.target.reset();
  });
};
